            ...
            return (
              <div class={`relative sm:grid sm:grid-flow-col sm:grid-cols-12 py-5 pr-5 pl-2 hover:bg-gray-100 border-2 border-transparent dark:hover:bg-gray-900`} title={`task priority: ${task.priority}`} data-task={task.task_id}>
                ...
                <div class="col-span-2 mt-5 sm:mt-0 w-full text-right ml-2 actions flex flex-row align-center items-center justify-center">
                  <button class="block text-xs py-2 px-2 text-whit border border-transparent hover:border hover:border-white" onClick$={() => editTask(task)} title="edit task">
                  ...
                  <button class="block text-xs py-2 px-2 text-white border border-transparent hover:border hover:border-white" onClick$={() => copyTask(task)} title="copy task">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      <path
                  ...
                  <button class="block text-xs py-2 px-2 text-white border border-transparent hover:border hover:border-white" onClick$={() => deleteTask(task)} title="delete task">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="white" class="w-6 h-6 fill-red-500">
                      <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
